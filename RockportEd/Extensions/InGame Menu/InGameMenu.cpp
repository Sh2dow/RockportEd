    ...
    namespace InGameMenu
    {
        ...
        void WINAPI beginScene(LPDIRECT3DDEVICE9 pDevice)
        {
            if (!isImguiInitialized)
            {
                ...
                imguiIO->Fonts->AddFontFromMemoryCompressedTTF(RobotoMedium::RobotoMedium_compressed_data,
                                                               RobotoMedium::RobotoMedium_compressed_size, 21.0f);
                imguiIO->Fonts->AddFontFromMemoryCompressedTTF(CooperHewitt_Roman_compressed_data,
                                                               CooperHewitt_Roman_compressed_size, 64.0f);
                imguiIO->Fonts->AddFontFromMemoryCompressedTTF(CooperHewitt_Bold_compressed_data,
                                                               CooperHewitt_Bold_compressed_size, 64.0f);
                imguiIO->Fonts->AddFontFromMemoryCompressedTTF(Aramis_Book_Italic::Aramis_Book_Italic_compressed_data,
                                                               Aramis_Book_Italic::Aramis_Book_Italic_compressed_size,
                                                               22.0f);
                imguiIO->Fonts->AddFontFromMemoryCompressedTTF(Aramis_Book_Italic::Aramis_Book_Italic_compressed_data,
                                                               Aramis_Book_Italic::Aramis_Book_Italic_compressed_size,
                                                               100.0f);
                ...
                ImGui::SetColorEditOptions(
                    ImGuiColorEditFlags_AlphaBar | ImGuiColorEditFlags_AlphaPreview | ImGuiColorEditFlags_NoOptions
        ...
        void WINAPI endScene(LPDIRECT3DDEVICE9 pDevice)
        {
            if (isImguiInitialized)
            {
                if (isMainWindowVisible)
                {
                    ...
                    if (ImGui::Begin("##RockportEd_Main", nullptr,
                                     ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoTitleBar))
                    {
                        ...
                        ImGui::SameLine(10.0f + diff.x);
                        ImGui::SetCursorPosY(1.0f + ImGui::GetStyle().WindowPadding.y);
