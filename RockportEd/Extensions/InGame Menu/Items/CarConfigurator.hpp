    ...
    namespace InGameMenu
    {
        ...
        public:
            ...
            bool loadPreset(LPVOID* pListActivePreset, const char** /*pListActivePresetName*/)
            {
                ...
                GameInternals::Gameplay::Player::Car::setCarPhysicsTuning(
                    reinterpret_cast<CarPhysicsTuning*>(&activeCarConfigPreset.PhysicsTuning));
            ...
            const virtual bool displayMenu() override
            {
                if (GameInternals::Gameplay::Object::getRigidBodyData(rigidBodyData))
                {
                    ...
                    ImGui::Indent(5.0f);
                    {
                        ...
                        ImGui::SliderFloat("Ride Height", &activeCarConfigPreset.PhysicsTuning.RideHeight, -10.0f,
                                           10.0f);
                        ImGui::SliderFloat("Aerodynamics", &activeCarConfigPreset.PhysicsTuning.Aerodynamics, -10.0f,
                                           10.0f);
