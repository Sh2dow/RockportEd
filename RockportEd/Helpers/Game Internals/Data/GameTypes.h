...
#pragma endregion
            ...
            struct GManager
            {
                ...
                static GIcon* AllocIcon(GIconType iconType, Vector3* pCoordinates, const float unk1 = 0.0f,
                                        const bool unk2 = true)
                {
                    return ((GIcon*(__thiscall*)(GManager*, GIconType, Vector3*, float, bool))0x5E9EC0)(
                        *mObj, iconType, pCoordinates, unk1, unk2);
                }
            ...
            struct VehicleParams /* : Sim::Params */
            {
                ...
                /* 0x28 */
                LPVOID __unk2; // related to Physics::*
                /* 0x2C */
            ...
            struct RigidBodyData
            {
                ...
                float Radius;
                /* +0x70 */
                UMath::Vector4 Rotation; // RightVector
                /* +0x80 */
                UMath::Vector4 UpVector; // OrientToGround
                /* +0x90 */
                UMath::Vector4 ForwardVector;
                /* +0xA0 */
                unsigned char __unk3[0x4 * 4];
            ...
            struct RigidBody
            {
                ...
                /* +0x30 */
                RigidBodyData** ppRigidBodyData;
                unsigned char __unk2[0xC];
                /* +0x3C */
                DWORD* pSomethingRelatedToPhysics;
                unsigned char __unk3[0x4C];
                /* +0x88 */
                UMath::Vector3 GroundNormal;
            ...
            public:
                ...
                {
                    ((void(__thiscall*)(RigidBody*, UMath::Vector3*, bool))
                        0x697570)(this, out_pWorldVector3, normalize);
                }

                void ConvertWorldToLocal(UMath::Vector3* out_pLocalVector3, bool normalize)
                {
                    ((void(__thiscall*)(RigidBody*, UMath::Vector3*, bool))
                        0x6975C0)(this, out_pLocalVector3, normalize);
                }
                ...
                {
                    ((void(__thiscall*)(RigidBody*, bool, float))0x697020)(
                        getFunctionPointer(0x8), isAttachedToWorld, unk);
                }
            ...
            struct PVehicle : PhysicsObject, IVehicle, EventSequencer::IContext, IExplodeable, IAttributeable
            {
                ...
                virtual LPVOID OnExplosion(const UMath::Vector3&, const UMath::Vector3&, float,
                                           LPVOID IExplosion) override;
                // IAttributeable overrides
                virtual LPVOID OnAttributeChange(const LPVOID Attrib__Collection, uint32_t) override;

                PVehicle() = default;

                static PVehicle* Create(DriverClass driverClass, DWORD carModelHash,
                                        FECustomizationRecord* pFECustomizationRecord,
                                        UMath::Vector3& initialRotation, UMath::Vector3& initialPosition)
                {
                    ...
                    return ((PVehicle*(__cdecl*)(DWORD, DWORD, DWORD, VehicleParams*))0x41CB10)(
                        typeHash, vehicleParams.typeName, vehicleParams.someFixedHash, &vehicleParams);
                }
            };
        }
    }
