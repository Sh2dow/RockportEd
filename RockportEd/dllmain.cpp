...
DWORD WINAPI Init(LPVOID)
{
    ...
    MirrorHook::PrepareFor(MirrorHook::Game::Carbon);
    ...
    static std::string copyright =
        "Copyright (c) 2018 Berkay Yi�it - berkay(2578). Greetz to GamerZ, still learning from him somehow. SpeedyHeart is honestly the most annoying, egomaniac person I've ever had contact with, may god help them.";
    return TRUE;
}
