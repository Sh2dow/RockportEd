...
#define DegreeToRadianMultiplier 0.0174532925f
                            ...
                            // RPM drawing
                            {
                                ...
                                static const float rpmAngleDiff_BeginningToFinal_FullRange = rpmFinalAngle_FullRange -
                                    rpmBeginningAngle_FullRange;
                                ...
                                const float rpmBeginningAngle_Redline = rpmBeginningAngle_FullRange + ((
                                        rpmBeginningValue_Redline / rpmValueMaximum) *
                                    rpmAngleDiff_BeginningToFinal_FullRange);
                                const float rpmValueDiff_BeginningToFinal_Redline = rpmValueMaximum -
                                    rpmBeginningValue_Redline;
                                const float rpmAngleDiff_BeginningToFinal_Redline = rpmFinalAngle_FullRange -
                                    rpmBeginningAngle_Redline;

                                const float rpmValueCurrent_ToAngle_FullRange =
                                    rpmBeginningAngle_FullRange + // Set the minimum starting angle
                                    ((rpmValueCurrent
                                            / rpmValueMaximum)
                                        // Get the percentage of the current RPM against the maximum RPM of the HUD
                                        * rpmAngleDiff_BeginningToFinal_FullRange
                                        // Calculate the final angle of the percentage
                                    );
                                const float rpmValueCurrent_ToAngle_NormalRange = min(
                                    rpmBeginningAngle_Redline, rpmValueCurrent_ToAngle_FullRange);
                                const float rpmValueCurrent_ToAngle_Redline =
                                    ...
                                    ((max(0, // Wrap in max(0,x) to ensure no negatives
                                          rpmValueCurrent - rpmBeginningValue_Redline)
                                            // Offset the current RPM with beginning value of the redline
                                            / rpmValueDiff_BeginningToFinal_Redline)
                                        // Get the percentage of the calculated RPM against the total redline RPM of the HUD
                                        * rpmAngleDiff_BeginningToFinal_Redline
                                        // Calculate the final angle of the percentage
                                    );

                                const float rpmBeginningAngle_FullRange_InRads = rpmBeginningAngle_FullRange *
                                    DegreeToRadianMultiplier;
                                const float rpmFinalAngle_FullRange_InRads = rpmFinalAngle_FullRange *
                                    DegreeToRadianMultiplier;
                                const float rpmBeginningAngle_Redline_InRads = rpmBeginningAngle_Redline *
                                    DegreeToRadianMultiplier;
                                const float rpmValueCurrent_ToAngle_FullRange_InRads = rpmValueCurrent_ToAngle_FullRange
                                    * DegreeToRadianMultiplier;
                                const float rpmValueCurrent_ToAngle_NormalRange_InRads =
                                    rpmValueCurrent_ToAngle_NormalRange * DegreeToRadianMultiplier;
                                const float rpmValueCurrent_ToAngle_Redline_InRads = rpmValueCurrent_ToAngle_Redline *
                                    DegreeToRadianMultiplier;
                                ...
                                // Gauge
                                {
                                    // RPM drawing (Normal Range)
                                    {
                                        // Background
                                        {
                                            draw_list->PathArcTo(
                                                ...
                                                size,
                                                activeHUDColourPreset.ClearBackgroundColours
                                            ...
                                            if (activeHUDColourPreset.DrawGradients)
                                            {
                                                ImVec2 gradient_p[2]{
                                                    ImVec2(
                                                        cursorPos.x + size + cosf(rpmBeginningAngle_FullRange_InRads) *
                                                        size,
                                                        cursorPos.y + size + sinf(rpmBeginningAngle_FullRange_InRads) *
                                                        size),
                                                    ImVec2(
                                                        cursorPos.x + size + cosf(rpmBeginningAngle_Redline_InRads) *
                                                        size,
                                                        cursorPos.y + size + sinf(rpmBeginningAngle_Redline_InRads) *
                                                        size)
                                                };

                                                ImU32 col[2]{
                                                    activeHUDColourPreset.RPMGauge_NormalRange_Background_Colour,
                                                    activeHUDColourPreset.
                                                    RPMGauge_NormalRange_Background_Colour_GradientEnd
                                                };
                                            ...
                                            else
                                            {
                                                draw_list->PathStroke(
                                                    activeHUDColourPreset.RPMGauge_NormalRange_Background_Colour, false,
                                                    size * 0.1f);
                                            }
                                        }
                                        ...
                                        // Foreground
                                        {
                                            ...
                                            if (activeHUDColourPreset.DrawGradients)
                                            {
                                                ImVec2 gradient_p[2]{
                                                    ImVec2(
                                                        ...
                                                        size),
                                                    ImVec2(
                                                        cursorPos.x + size + cosf(
                                                            rpmValueCurrent_ToAngle_NormalRange_InRads) * size,
                                                        cursorPos.y + size + sinf(
                                                            rpmValueCurrent_ToAngle_NormalRange_InRads) * size)
                                                };
                                                ...
                                                ImU32 col[2]{
                                                    ...
                                                    activeHUDColourPreset.
                                                    RPMGauge_NormalRange_Foreground_Colour_GradientEnd
                                                };
                                                draw_list->PathStrokeGradient(gradient_p, col, false, size * 0.1f);
                                            }
                                            else
                                            {
                                                draw_list->PathStroke(
                                                    activeHUDColourPreset.RPMGauge_NormalRange_Foreground_Colour, false,
                                                    size * 0.1f);
                                            }
                                        }
                                    }
                                    // RPM drawing (Redline)
                                    {
                                        // Background
                                        {
                                            ...
                                            if (activeHUDColourPreset.DrawGradients)
                                            {
                                                ImVec2 gradient_p[2]{
                                                    ImVec2(
                                                        ...
                                                        size),
                                                    ImVec2(
                                                        cursorPos.x + size + cosf(rpmFinalAngle_FullRange_InRads) *
                                                        size,
                                                        cursorPos.y + size + sinf(rpmFinalAngle_FullRange_InRads) *
                                                        size)
                                                };
                                            ...
                                            {
                                                draw_list->PathStroke(
                                                    activeHUDColourPreset.RPMGauge_Redline_Background_Colour, false,
                                                    size * 0.1f);
                                            }
                                        }
                                        // Foreground
                                        {
                                            ...
                                            if (activeHUDColourPreset.DrawGradients)
                                            {
                                                ImVec2 gradient_p[2]{
                                                    ...
                                                    ImVec2(
                                                        cursorPos.x + size + cosf(
                                                            rpmValueCurrent_ToAngle_Redline_InRads) * size,
                                                        cursorPos.y + size + sinf(
                                                            rpmValueCurrent_ToAngle_Redline_InRads) * size)
                                                };
                                            ...
                                            {
                                                draw_list->PathStroke(
                                                    activeHUDColourPreset.RPMGauge_Redline_Foreground_Colour, false,
                                                    size * 0.1f);
                                            }
                                        }
                                    }
                            ...
                            // Speed drawing
                            {
                                const GameInternals::SpeedUnit speedUnitType =
                                    GameInternals::Config::Gameplay::getSpeedUnitType();
                                ...
                                sprintf_s(speedUnitTypeToText, "%s",
                                          speedUnitType == GameInternals::SpeedUnit::KMH
                                              ? "KMH"
                                              : speedUnitType == GameInternals::SpeedUnit::MPH
                                              ? "MPH"
                                              : "MPS"
                                );
                                ...
                                // Speed value
                                {
                                    ...
                                    // Background filler
                                    {
                                        ...
                                        ImGui::TextColored(activeHUDColourPreset.SpeedDisplay_FillerText_Colour,
                                                           speedValueBackgroundText);
                                    }
                                    // Value
                                    {
                                        ...
                                        ImGui::SetCursorScreenPos(speedTextDrawingCursorPosition);
                                        ImGui::TextColored(activeHUDColourPreset.SpeedDisplay_ValueText_Colour,
                                                           speedValueToText);
                                    }
                                    ImGui::PopFont();
                                }
                                // Speed Unit
                                {
                                    ...
                                    ImGui::SetCursorScreenPos(speedTextDrawingCursorPosition);
                                    ImGui::TextColored(activeHUDColourPreset.SpeedDisplay_UnitTypeText_Colour,
                                                       speedUnitTypeToText);
                            ...
                            // NOS drawing
                            {
                                ...
                                static const int nosMaximumSegments = static_cast<int>(NOSBarEndAngle -
                                    NOSBarRangeStartAngle); // this needs to be an odd number

                                const float nosValue = PlayerCarInternals::getNOSValue();
                                const int nosCurrentSegments = static_cast<int>(std::round(
                                    nosValue * nosMaximumSegments));
            ...
            const virtual bool displayMenu() override
            {
                ...
                if (isEnabled)
                {
                    ...
                    ImGui::SameLine();
                    ImGui::Checkbox("Clear background colours", &activeHUDColourPreset.ClearBackgroundColours);
                    ImGui::Checkbox("Let game draw gauges too",
                                    GameInternals::Config::Player::getIsShowGameGaugesAsPointer());

                    //ImGui::ColorEdit4("RPMGauge_BackColor", &activeHUDColourPreset.RPMGauge_BackColour.Value.x);

                    ImGui::ColorEdit4("RPMGauge_NormalRange_Background_Colour",
                                      &activeHUDColourPreset.RPMGauge_NormalRange_Background_Colour.Value.x);
                    if (activeHUDColourPreset.DrawGradients)
                        ImGui::ColorEdit4("RPMGauge_NormalRange_Background_Colour_GradientEnd",
                                          &activeHUDColourPreset.RPMGauge_NormalRange_Background_Colour_GradientEnd.
                                                                 Value.x);

                    ImGui::ColorEdit4("RPMGauge_NormalRange_Foreground_Colour",
                                      &activeHUDColourPreset.RPMGauge_NormalRange_Foreground_Colour.Value.x);
                    if (activeHUDColourPreset.DrawGradients)
                        ImGui::ColorEdit4("RPMGauge_NormalRange_Foreground_Colour_GradientEnd",
                                          &activeHUDColourPreset.RPMGauge_NormalRange_Foreground_Colour_GradientEnd.
                                                                 Value.x);

                    ImGui::ColorEdit4("RPMGauge_Redline_Background_Colour",
                                      &activeHUDColourPreset.RPMGauge_Redline_Background_Colour.Value.x);
                    if (activeHUDColourPreset.DrawGradients)
                        ImGui::ColorEdit4("RPMGauge_Redline_Background_Colour_GradientEnd",
                                          &activeHUDColourPreset.RPMGauge_Redline_Background_Colour_GradientEnd.Value.
                                                                 x);

                    ImGui::ColorEdit4("RPMGauge_Redline_Foreground_Colour",
                                      &activeHUDColourPreset.RPMGauge_Redline_Foreground_Colour.Value.x);
                    if (activeHUDColourPreset.DrawGradients)
                        ImGui::ColorEdit4("RPMGauge_Redline_Foreground_Colour_GradientEnd",
                                          &activeHUDColourPreset.RPMGauge_Redline_Foreground_Colour_GradientEnd.Value.
                                                                 x);

                    ImGui::ColorEdit4("RPMGauge_Needle_Foreground_Color",
                                      &activeHUDColourPreset.RPMGauge_Needle_Foreground_Colour.Value.x);
                    ImGui::Separator();

                    ImGui::ColorEdit4("SpeedDisplay_UnitTypeText_Color",
                                      &activeHUDColourPreset.SpeedDisplay_UnitTypeText_Colour.Value.x);
                    ImGui::ColorEdit4("SpeedDisplay_FillerText_Color",
                                      &activeHUDColourPreset.SpeedDisplay_FillerText_Colour.Value.x);
                    ImGui::ColorEdit4("SpeedDisplay_ValueText_Color",
                                      &activeHUDColourPreset.SpeedDisplay_ValueText_Colour.Value.x);
                    ImGui::Separator();

                    //ImGui::ColorEdit4("NOSBar_Background_Color", &activeHUDColourPreset.NOSBar_Background_Colour.Value.x);
                    ImGui::ColorEdit4("NOSBar_Value_Background_Color",
                                      &activeHUDColourPreset.NOSBar_Value_Background_Colour.Value.x);
                    ImGui::ColorEdit4("NOSBar_Value_Foreground_Color",
                                      &activeHUDColourPreset.NOSBar_Value_Foreground_Colour.Value.x);
                }
                return true;
            }
        };
